...
function deleteButton({userID, productId, onWishlistChange}) {
  ...
  return (
    <button type="button" onClick={remove} className="text-blue-700 hover:text-white border-2 hover:bg-red-700   font-medium rounded-lg text-sm px-5 py-2.5 w-full">Remove</button>
  )
}
