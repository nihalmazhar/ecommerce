...
export default function ModalContent({ onClose, itemId }) {
  ...
  const handleUpdate = async () => {
    try{const response = await axios.put(`${baseURL}/${itemId}`,  newSelectedProduct )
    ...
    <ToastContainer position="bottom-center" autoClose={2500}
      ...
      <div className=" modal bg-white border-2 shadow-md rounded-md p-2 absolute left-2/4 top-2/4 transform -translate-x-1/2 -translate-y-1/2  w-[40vw] h-[80vh]">
        ...
        <div className="h-[80%] overflow-y-scroll">
          <div className="my-1 text-gray-500"><span  className="mr-1">Product ID :</span>{selectedProduct._id} </div>
          ...
          <div>
            ...
            <Select
              ...
              name="category"
              id="category"
              defaultValue={{ value: selectedProduct.category, label: selectedProduct.category }}
          ...
          <div>
            ...
            <Select
              ...
              name="origin"
              id="origin"
              defaultValue={{ value: selectedProduct.origin, label: selectedProduct.origin }}
        ...
        <div className="flex justify-end">
          <button onClick={handleUpdate}  className="bg-green-500 text-white p-1 px-2 m-2 rounded-md hover:bg-green-700 ">
            Update
          </button>
        </div>
      </div>
